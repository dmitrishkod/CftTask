...
файлы или же там может быть множество папок внутри, но файлы все равно должны быть одного формата txt,
другие форматы программа будет игнорировать. Указываем корректный путь полностью;
>- cортировка строк будет основываться на количестве элементов в этой строке;
>- если файл для сортировки один - то он отсортируется в зависимости от настройки режима сортировки;
>- чтобы завершить программу - необходимо прописать "end" в командной строке;
>- 
