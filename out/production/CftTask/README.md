...
>- если файл для сортировки не может быть один, иначе смысл в сортировки теряется, так как
он уже должен быть предварительно отсортирован;
...
игнорировать и в конечном результате они не будут выявлены;
>- кол-во созданных txt файлов от 2 до 3 - с другим кол-вом программа будет работать
не корректно.
